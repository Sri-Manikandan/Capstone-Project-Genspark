...
export const ORGANIZER_ROUTES: Routes = [
  ...
  { path: 'events/:id/screenings', component: ScreeningsComponent },
  { path: 'screenings/:screeningId/tickets', component: TicketTypesComponent },
  { path: 'events/:id/orders', component: EventBookingsComponent },
